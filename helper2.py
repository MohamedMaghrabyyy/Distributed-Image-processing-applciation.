...
import numpy as np
def process_grey_B(ctx,queue, B, height, width, grey_kernel):
  """
...
def apply_intensity_kernel_B(ctx,queue, B, value, bright_kernel, dark_kernel):
        """
...
def apply_intensity_kernel_grey(ctx,queue, channel, value, bright_kernel, dark_kernel):
        """
        Apply brightness/darkness adjustment to a single channel using OpenCL kernel
        """
